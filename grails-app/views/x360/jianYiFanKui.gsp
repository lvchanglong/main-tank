...
<html>
	...
	<body>
		<div id="jianYiFanKui" class="borderBox clearfix defaultPage">
			...
			<h1>建议反馈</h1>
			<g:formRemote name="fanKui-save" url="[controller:'fanKuiRestful', action:'save']" onSuccess="fanKuiSaveSuccess(data,textStatus)" onFailure="fanKuiSaveFailure(XMLHttpRequest,textStatus,errorThrown)" class="clearfix">
				...
				<div id="fanKui-save-status" class="tiShi">(^_,^ )：“我今天又没吃药，感觉自己萌萌哒...”</div>
