<div id="yonghu-kongjian-0">
	<ul class="main-ul borderBox clearfix">
		...
		<li class="main-li">
			<g:remoteLink controller="x520" action="geRenZiLiao" update="yonghu-kongjian-0-wrapper" id="${ yongHuInstance.id }" class="aList">
				<asset:image src="WangLuo/SuCai/个人资料.png"/>
			</g:remoteLink>
		</li>
		<li class="main-li">
			<g:remoteLink controller="x520" action="geRenShuoShuo" update="yonghu-kongjian-0-wrapper" id="${ yongHuInstance.id }" class="aList">
