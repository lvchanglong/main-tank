<div id="yonghu-kaPai">
	<asset:image src="${ yonghu.touXiang }" class="touXiang"/>
	<asset:image src="WangLuo/TouXiang/BeiJing/左侧C.png" class="leftFrame"/>
</div>

<%--<div id="yonghu-info" class="borderBox">
	<div class="main wrapper borderBox">
		...
		<div class="right borderBox" >
			<asset:image src="${ yonghu.touXiang }"/>
			<div class="dengji">
				${ yonghu.zhanDouLi }&nbsp;级
			</div>
